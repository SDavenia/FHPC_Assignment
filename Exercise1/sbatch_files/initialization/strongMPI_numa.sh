...
out_generate=results/initialization/strong_MPI_numa_generate_new.csv # To write times
out_write=results/initialization/strong_MPI_numa_write_new.csv # To write times
