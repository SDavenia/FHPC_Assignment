...
out_filename=results/initialization/strong_MPI_numa.csv # To write times
...
do
    ...
    do
        ...
        do
            ...
            time_value=$(grep -o 'Initialize time: [0-9.]*' output_initialization_strong_MPI_numa.txt | awk '{print $3}')
